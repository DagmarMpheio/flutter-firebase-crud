...
class DadorUpdateView extends StatefulWidget {
  const DadorUpdateView({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DadorUpdateViewState createState() => _DadorUpdateViewState();
}

class _DadorUpdateViewState extends State<DadorUpdateView> {
  ...
  void initState() {
    ...
    senhaController.text = data.senha.toString();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: const Text("Editar Dador")),
        body: Obx(
          () => LoadingOverlay(
                  ...
                  children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: CountryCodePicker(
                              onChanged: (country) {
                                ...
                                if (country == null) {
                                  country = data.mobileCode as CountryCode;
                                } else {
                                  mobileCode = country.dialCode.toString();
                                }
                              },
                              hideMainText: true,
                              initialSelection: data.mobileCode.toString(),
                    ...
                    Center(
                      child: DropdownButtonFormField2(
                        ...
                        isExpanded: true,
                        hint: Text(data.provincia.toString()),
                        icon: const Icon(
                    ...
                    Center(
                      child: DropdownButtonFormField2(
                        ...
                        isExpanded: true,
                        hint: Text(data.grupoSanguineo.toString()),
                        icon: const Icon(
                          Icons.arrow_drop_down,
                          color: Colors.black45,
                        ),
                        ...
                        // ignore: body_might_complete_normally_nullable
                        validator: (value) {
                          value ??= data.grupoSanguineo.toString();
                        },
                        onChanged: (value) {
                          //mostrar dinamicamente a provincia
                          setState(() {
